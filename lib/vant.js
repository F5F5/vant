...
function create_basic_install(Vue) {
...
/* harmony default export */ var es_cell = (create_basic({
  render: function render() {
    var _vm = this;
...
/* harmony default export */ var es_picker = (create({
  render: function render() {
    var _vm = this;
...
var version = '1.4.8';
var components = [actionsheet, address_edit, address_list, es_area, badge, badge_group, es_button, card, es_cell, cell_group, es_checkbox, checkbox_group, circle, col, collapse, collapse_item, contact_card, contact_edit, contact_list, coupon_cell, coupon_list, datetime_picker, dialog, field, goods_action, goods_action_big_btn, goods_action_mini_btn, icon, image_preview, info, list, loading, es_locale, nav_bar, notice_bar, notify, number_keyboard, overlay, pagination, panel, password_input, es_picker, es_popup, es_progress, pull_refresh, es_radio, radio_group, es_rate, row, search, sku, slider, step, stepper, steps, submit_bar, swipe, swipe_cell, swipe_item, es_switch, switch_cell, tab, tabbar, tabbar_item, tabs, tag, es_toast, tree_select, uploader];
